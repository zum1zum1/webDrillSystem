...
public class QuestionEditServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		String questionIdString = request.getParameter("edit");
		System.out.println(questionIdString);
		...
		getServletContext().getRequestDispatcher("/jsp/teacher/questionEdit.jsp").forward(request, response);
